...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 343DE3AFC5A
	for <lists+linux-pwm@lfdr.de>; Tue, 22 Jun 2021 07:02:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229927AbhFVFEh (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Tue, 22 Jun 2021 01:04:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56864 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229928AbhFVFEg (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Tue, 22 Jun 2021 01:04:36 -0400
Received: from mail-oi1-x22e.google.com (mail-oi1-x22e.google.com [IPv6:2607:f8b0:4864:20::22e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B59D1C061574
        for <linux-pwm@vger.kernel.org>; Mon, 21 Jun 2021 22:02:19 -0700 (PDT)
Received: by mail-oi1-x22e.google.com with SMTP id s23so22467403oiw.9
        for <linux-pwm@vger.kernel.org>; Mon, 21 Jun 2021 22:02:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=pvL7YFUxonrihwSwDyMbDmIKPwQ2v6C4i2jMOUwPDjM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pvL7YFUxonrihwSwDyMbDmIKPwQ2v6C4i2jMOUwPDjM=;
        b=
X-Gm-Message-State: AOAM530lD6D36EleZc885ASeYJHigT7N+490xw7ORA+0biepcUD3d5Yi
        RIE0VpE0SrPRE5RnNhGtMKuqOg==
X-Google-Smtp-Source: ABdhPJyE7ceK/a8QM20S953rQ4CSve6lPwl9rPZ0tvJG/gOafsZ7K31kv+TutUdP0yj1IUrEhwtccQ==
X-Received: by 2002:a05:6808:1388:: with SMTP id c8mr1524047oiw.17.1624338138760;
        Mon, 21 Jun 2021 22:02:18 -0700 (PDT)
Received: from localhost.localdomain (104-57-184-186.lightspeed.austtx.sbcglobal.net. [104.57.184.186])
        by smtp.gmail.com with ESMTPSA id r1sm4467744oth.19.2021.06.21.22.02.17
...
Subject: [PATCH v8 2/2] leds: Add driver for Qualcomm LPG
Date:   Mon, 21 Jun 2021 22:01:12 -0700
Message-Id: <20210622050113.231902-2-bjorn.andersson@linaro.org>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <20210622050113.231902-1-bjorn.andersson@linaro.org>
References: <20210622050113.231902-1-bjorn.andersson@linaro.org>
MIME-Version: 1.0
...
- Return error from pwm_chip apply function when too small period is requested
 ...
 drivers/leds/rgb/leds-qcom-lpg.c | 1298 ++++++++++++++++++++++++++++++
...
new file mode 100644
index 000000000000..de219249a267
--- /dev/null
...
+	 * anything below 27uS.
+	 */
+	if (period <= NSEC_PER_SEC * LPG_RESOLUTION / 19200000)
+		return -EINVAL;
+
+	/*
...
+			denom = NSEC_PER_SEC * lpg_pre_divs[div] * (1 << 9);
+
+			if (nom < denom)
+				continue;
+
...
+				m = LPG_MAX_M;
+
+			actual = DIV_ROUND_UP(denom * (1 << m), lpg_clk_rates[clk]);
+
+			error = period - actual;
+			if (error < best_err) {
+				best_err = error;
...
+			lpg_calc_freq(chan, NSEC_PER_MSEC);
+
+			duty = brightness * chan->period / cdev->max_brightness;
...
+
+	chan = led->channels[0];
+	duty = chan->pwm_value * chan->period / LPG_RESOLUTION;
+	*delay_on = duty / NSEC_PER_MSEC;
+	*delay_off = (chan->period - duty) / NSEC_PER_MSEC;
+
+	return 0;
+}
+
...
+	struct lpg *lpg = container_of(chip, struct lpg, pwm);
+	struct lpg_channel *chan = &lpg->channels[pwm->hwpwm];
+	u64 duty = DIV_ROUND_UP(chan->pwm_value * chan->period, LPG_RESOLUTION - 1);
+
