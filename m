...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EB3FD2ACAF
	for <lists+linux-pwm@lfdr.de>; Mon, 27 May 2019 02:36:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726052AbfE0Agw (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Sun, 26 May 2019 20:36:52 -0400
Received: from www3345.sakura.ne.jp ([49.212.235.55]:17530 "EHLO
        www3345.sakura.ne.jp" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726008AbfE0Agw (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Sun, 26 May 2019 20:36:52 -0400
Received: from fsav106.sakura.ne.jp (fsav106.sakura.ne.jp [27.133.134.233])
        by www3345.sakura.ne.jp (8.15.2/8.15.2) with ESMTP id x4R0amJK058082;
        Mon, 27 May 2019 09:36:48 +0900 (JST)
...
Received: from localhost (p14010-ipadfx41marunouchi.tokyo.ocn.ne.jp [61.118.107.10])
        ...
        by www3345.sakura.ne.jp (8.15.2/8.15.2) with ESMTPSA id x4R0aeqW058007
...
Subject: [PATCH v4] pwm: renesas-tpu: Add suspend/resume function
Date:   Mon, 27 May 2019 09:36:39 +0900
Message-Id: <1558917399-7065-1-git-send-email-cv-dong@jinso.co.jp>
...
---
 drivers/pwm/pwm-renesas-tpu.c | 42 ++++++++++++++++++++++++++++++++++++++++++
 1 file changed, 42 insertions(+)

diff --git a/drivers/pwm/pwm-renesas-tpu.c b/drivers/pwm/pwm-renesas-tpu.c
index 4a855a2..3c2819b 100644
--- a/drivers/pwm/pwm-renesas-tpu.c
+++ b/drivers/pwm/pwm-renesas-tpu.c
@@ -366,6 +366,47 @@ static void tpu_pwm_disable(struct pwm_chip *chip, struct pwm_device *_pwm)
...
+
 static const struct pwm_ops tpu_pwm_ops = {
 	...
 	.free = tpu_pwm_free,
@@ -459,6 +500,7 @@ static struct platform_driver tpu_driver = {
 	.remove		= tpu_remove,
 	.driver		= {
