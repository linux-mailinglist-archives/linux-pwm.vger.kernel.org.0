Return-Path: <linux-pwm+bounces-9540-lists+linux-pwm=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-pwm@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id wNirJGXVR2r0fwAAu9opvQ
	(envelope-from <linux-pwm+bounces-9540-lists+linux-pwm=lfdr.de@vger.kernel.org>)
	for <lists+linux-pwm@lfdr.de>; Fri, 03 Jul 2026 17:29:41 +0200
X-Original-To: lists+linux-pwm@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D1E49703E1E
	for <lists+linux-pwm@lfdr.de>; Fri, 03 Jul 2026 17:29:40 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=bootlin.com header.s=dkim header.b="AnPY/nnE";
	dmarc=pass (policy=reject) header.from=bootlin.com;
	spf=pass (mail.lfdr.de: domain of "linux-pwm+bounces-9540-lists+linux-pwm=lfdr.de@vger.kernel.org" designates 2600:3c0a:e001:db::12fc:5321 as permitted sender) smtp.mailfrom="linux-pwm+bounces-9540-lists+linux-pwm=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id E838C30BAE12
	for <lists+linux-pwm@lfdr.de>; Fri,  3 Jul 2026 15:22:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AD3C8414DEB;
	Fri,  3 Jul 2026 15:22:40 +0000 (UTC)
X-Original-To: linux-pwm@vger.kernel.org
Received: from smtpout-03.galae.net (smtpout-03.galae.net [185.246.85.4])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E91EB414DFD
	for <linux-pwm@vger.kernel.org>; Fri,  3 Jul 2026 15:22:37 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1783092160; cv=none; b=ZAoZIhZdvCin+/KchrbG/2X0HNxmlsV6SeKMqeQEMOFOXwWPjr9ccN6EDMXb9/BBKoPd16RXFzkn+qF/99AWxn86YUElymP0A+LX+duFsgxlUIU1MBTRRBO/TPjn/gy7q3+9L3ZcB+o/Cc1R9Tcwht3lX8re5HPgguTcHRgyq0Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1783092160; c=relaxed/simple;
	bh=FDUL48XBeYjRA0DyUN8HiwoLNeLPaIkMq8CYzYEfg34=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=upGZlKBwMefbJeRTRqpoNJ3vcc/NPFaDDtWGq4D3dT6MiFKVHyYbGvXAB8aXQXdLVuVFu2gIeq0tbqw6flUXCjMtgNoqspX8+D/RPXyD+oa7V/bL3X696GPhrTay+vYO7Vntf0NiJ18WuGRT3kvNs2o8WQlB5sfKXIVwLTtIhoI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=AnPY/nnE; arc=none smtp.client-ip=185.246.85.4
Received: from smtpout-01.galae.net (smtpout-01.galae.net [212.83.139.233])
	by smtpout-03.galae.net (Postfix) with ESMTPS id 878C04E40C6C;
	Fri,  3 Jul 2026 15:22:36 +0000 (UTC)
Received: from mail.galae.net (mail.galae.net [212.83.136.155])
	by smtpout-01.galae.net (Postfix) with ESMTPS id 5D1FD60300;
	Fri,  3 Jul 2026 15:22:36 +0000 (UTC)
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon) with ESMTPSA id 497AB104C95AC;
	Fri,  3 Jul 2026 17:22:32 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bootlin.com; s=dkim;
	t=1783092154; h=from:subject:date:message-id:to:cc:mime-version:
	 content-transfer-encoding:in-reply-to:references;
	bh=0SrXW7Z2N4X2kmm2dGCHJB4gpBHccP6ySMAPao9VTAE=;
	b=
...
Subject: [PATCH v7 2/4] pwm: sun8i: Add H616 PWM support
Date: Fri,  3 Jul 2026 17:22:13 +0200
Message-ID: <20260703152215.192859-3-richard.genoud@bootlin.com>
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-9540-lists,linux-pwm=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,bootlin.com:from_mime,bootlin.com:email,bootlin.com:mid,bootlin.com:dkim,vger.kernel.org:from_smtp,schimsalabim.eu:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: D1E49703E1E
...
index e8886a9b64d9..6e055a3a748c 100644
