Return-Path: <linux-pwm+bounces-8063-lists+linux-pwm=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-pwm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CNiKCKkngmnPPgMAu9opvQ
	(envelope-from <linux-pwm+bounces-8063-lists+linux-pwm=lfdr.de@vger.kernel.org>)
	for <lists+linux-pwm@lfdr.de>; Tue, 03 Feb 2026 17:51:53 +0100
X-Original-To: lists+linux-pwm@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id E46B8DC4B9
	for <lists+linux-pwm@lfdr.de>; Tue, 03 Feb 2026 17:51:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id BA9F9305CF34
	for <lists+linux-pwm@lfdr.de>; Tue,  3 Feb 2026 16:48:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE7053D3318;
	Tue,  3 Feb 2026 16:48:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=garyguo.net header.i=@garyguo.net header.b="Rv05WgbL"
X-Original-To: linux-pwm@vger.kernel.org
Received: from CWXP265CU009.outbound.protection.outlook.com (mail-ukwestazon11021077.outbound.protection.outlook.com [52.101.100.77])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0B2623D301A;
	Tue,  3 Feb 2026 16:48:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.100.77
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770137283; cv=fail; b=dNYOStJ2UwKbl5eOUciH2Bdw7HG1hlVeY498K2zPL5eyEOCUEGEVCYVovwooztWdeWOpuj9rMgSnOn2nlitiMYmv/2OizmDz1XMrce64GlURhnU8hMhsZUmALGS1QD4VMceLR58Kd0dhWT/cQocqGohcRfb7BvRS03goyLdbF7E=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770137283; c=relaxed/simple;
	bh=6oPCkoBGfoY8TTLolbtkG4PSSP9UTCVOdVqsF3MXRJk=;
	h=Content-Type:Date:Message-Id:Cc:Subject:From:To:References:
	 In-Reply-To:MIME-Version; b=J/aT6cV6GleBWi01rfJoQnDbrdV53GIdI+hhGb10CDvIJxG5dend+prPdRbM0mPJuekX5pT7d+ibKpyRl74Eha15gQsJRQeNR4qZH1fE8l6/5NW4bBMLel9sEpQP857VFASk4wZvEsFpMU/vFAvK+hNNmhWt0yGhUoOg+71s++8=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=garyguo.net; spf=pass smtp.mailfrom=garyguo.net; dkim=pass (1024-bit key) header.d=garyguo.net header.i=@garyguo.net header.b=Rv05WgbL; arc=fail smtp.client-ip=52.101.100.77
...
X-Microsoft-Antispam:
	BCL:0;ARA:13230040|366016|10070799003|7416014|376014|1800799024|7053199007|921020;
X-Microsoft-Antispam-Message-Info:
	=?utf-8?B?TXk1cmNKVG5wTEpxcVVQY1VQYjdtLzNFbkxNSzBucjl2UVg2V3NYQzR6YVc0?=
...
X-Forefront-Antispam-Report:
	CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:LOVP265MB8871.GBRP265.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFS:(13230040)(366016)(10070799003)(7416014)(376014)(1800799024)(7053199007)(921020);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?K1dWVmRpT09vMzkzUjMyWnAyMEhzZDMwdExQZTRiSjdZZkdhdzNMVmdvckdw?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 03 Feb 2026 16:47:56.3199
 (UTC)
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-8063-lists,linux-pwm=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	RECEIVED_SPAMHAUS_BLOCKED_OPENRESOLVER(0.00)[100.90.174.1:received,2603:10a6:600:488::16:received,52.101.100.77:received];
	MID_RHS_MATCH_FROM(0.00)[];
	ASN(0.00)[asn:63949, ipnet:172.232.128.0/19, country:SG];
	TAGGED_RCPT(0.00)[linux-pwm];
	TO_DN_SOME(0.00)[]
X-Rspamd-Queue-Id: E46B8DC4B9
