Return-Path: <linux-pwm+bounces-109-lists+linux-pwm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pwm@lfdr.de
Delivered-To: lists+linux-pwm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A3077F2FC3
	for <lists+linux-pwm@lfdr.de>; Tue, 21 Nov 2023 14:52:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4636A1C2167A
	for <lists+linux-pwm@lfdr.de>; Tue, 21 Nov 2023 13:52:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0F44E5380C;
	Tue, 21 Nov 2023 13:52:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dkim=none
X-Original-To: linux-pwm@vger.kernel.org
Received: from metis.whiteo.stw.pengutronix.de (metis.whiteo.stw.pengutronix.de [IPv6:2a0a:edc0:2:b01:1d::104])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 254AA170A
	for <linux-pwm@vger.kernel.org>; Tue, 21 Nov 2023 05:52:10 -0800 (PST)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
	by metis.whiteo.stw.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
	(Exim 4.92)
	(envelope-from <ukl@pengutronix.de>)
	id 1r5RAe-0006iY-PM; Tue, 21 Nov 2023 14:52:08 +0100
Received: from [2a0a:edc0:0:900:1d::77] (helo=ptz.office.stw.pengutronix.de)
	by drehscheibe.grey.stw.pengutronix.de with esmtps  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
	(Exim 4.94.2)
	(envelope-from <ukl@pengutronix.de>)
	id 1r5RAd-00Ab3A-Su; Tue, 21 Nov 2023 14:52:07 +0100
Received: from ukl by ptz.office.stw.pengutronix.de with local (Exim 4.94.2)
	(envelope-from <ukl@pengutronix.de>)
	id 1r5RAd-004xiB-Jg; Tue, 21 Nov 2023 14:52:07 +0100
From: =?UTF-8?q?Uwe=20Kleine-K=C3=B6nig?= <u.kleine-koenig@pengutronix.de>
To: Thierry Reding <thierry.reding@gmail.com>
Cc: linux-pwm@vger.kernel.org,
	kernel@pengutronix.de
Subject: [PATCH v3 106/108] pwm: Ensure the memory backing a PWM chip isn't freed while used
Date: Tue, 21 Nov 2023 14:50:48 +0100
Message-ID: <20231121134901.208535-107-u.kleine-koenig@pengutronix.de>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=16100; i=u.kleine-koenig@pengutronix.de; h=from:subject; bh=1/7C96lt6fDMnAA79uM7XGsntpcpkmnu7zmv7B6KvE0=; b=owEBbQGS/pANAwAKAY+A+1h9Ev5OAcsmYgBlXLXBQACfHXPu2WFq3szClabSZ/OCnTzN1ahaH GQDuLnH77GJATMEAAEKAB0WIQQ/gaxpOnoeWYmt/tOPgPtYfRL+TgUCZVy1wQAKCRCPgPtYfRL+ TlHHB/4w4+XkQ/HskPNRKVC6hSFPsVqOg27HOnAfcu1fCSzx4erPkDi8vsvpv6hwoBCGdVrSwLk XPJSfelVpp/CdfJNTKEGLTvfOFms1btTDcPKQKdkQfq8iE9v6HvOua94qKvQusmpWJcOZRnL82b IuEqvmSF0n2pIHDcTXcUmtAfmwTdxUd+wREQYLdVWa6ghrzWjO8ADmPqckDg4MEA4YwJVgHi/3y 3D8xV/VPh5xCekdXg2lG6E11XDVdd2M3kTY3zf37TkRvUZCeVzm89lxbbte6ZbtOrAcDKGxj36P aLRG55oj1aKVWgrC+Cw52eTD7h5MKyVRFn6xOwf2Hu9r32U9
...
place it can happen that a reference is held to a chip with its driver
going away.
...
index 029aa1c69591..dd376fe9e265 100644
...
+	if (!chip || !chip->dev.parent || !chip->ops || !chip->npwm)
 	...
 	/*
@@ -259,25 +296,41 @@ int __pwmchip_add(struct pwm_chip *chip, struct module *owner)
 		return -EINVAL;
...
@@ -299,6 +352,10 @@ void pwmchip_remove(struct pwm_chip *chip)
 	idr_remove(&pwmchip_idr, chip->id);
...
@@ -395,18 +452,18 @@ static void pwm_apply_state_debug(struct pwm_device *pwm,
...
@@ -415,20 +472,20 @@ static void pwm_apply_state_debug(struct pwm_device *pwm,
 	    last->period == s2.period &&
...
@@ -436,7 +493,7 @@ static void pwm_apply_state_debug(struct pwm_device *pwm,
...
@@ -451,7 +508,7 @@ static void pwm_apply_state_debug(struct pwm_device *pwm,
...
@@ -599,7 +656,7 @@ static struct pwm_chip *fwnode_to_pwmchip(struct fwnode_handle *fwnode)
 	mutex_lock(&pwm_lock);
...
@@ -620,15 +677,15 @@ static struct device_link *pwm_device_link_add(struct device *dev,
...
@@ -950,7 +1007,7 @@ void pwm_put(struct pwm_device *pwm)
...
@@ -1090,8 +1147,8 @@ static int pwm_seq_show(struct seq_file *s, void *v)
...
index a7294ef1495d..081c8402155d 100644
