Return-Path: <linux-pwm+bounces-1046-lists+linux-pwm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pwm@lfdr.de
Delivered-To: lists+linux-pwm@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 78B2583C22A
	for <lists+linux-pwm@lfdr.de>; Thu, 25 Jan 2024 13:11:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 09DF4B21E7B
	for <lists+linux-pwm@lfdr.de>; Thu, 25 Jan 2024 12:11:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 24F563C097;
	Thu, 25 Jan 2024 12:11:07 +0000 (UTC)
X-Original-To: linux-pwm@vger.kernel.org
Received: from metis.whiteo.stw.pengutronix.de (metis.whiteo.stw.pengutronix.de [185.203.201.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B101436B0E
	for <linux-pwm@vger.kernel.org>; Thu, 25 Jan 2024 12:11:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.203.201.7
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706184667; cv=none; b=hrKr98UpAkHApVjEqblNXKNJJL8TOZqHPZWkSBY39gc/CFhmoiF5rAwJ38QKvDJEhDP7vUQ5yNm1RZnsv8EM+LI9nG6NCEUwrwwMMvKP15BMqDt9XXRsL/vnQ/lDnHxSpMSUcqw59LprWpHaMQMu41yFHBcVhUVFnRP5gCPwePo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706184667; c=relaxed/simple;
	bh=/Pn3H2sPKWQiH/mueBaf+2K/i8DAREnJPAk0QAkHukE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=GuyiwqvtyBoBX06bB1ggUGNBVKuSaulv+Teu6lkwB+7VqP+W3voZc0jtKTJe1GAFSpG+dZvIUxENndOL0z+qOkdlnqzw2bk+gmV6sArPuG/ekNCoxHXzmLDBRFUKy/lxJd652bx/zpG1VwqCllvMuduObSjm1waiO4dlv1YFMNs=
...
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
	...
	id 1rSyZS-0004ft-3g; Thu, 25 Jan 2024 13:11:02 +0100
Received: from [2a0a:edc0:0:900:1d::77] (helo=ptz.office.stw.pengutronix.de)
	by drehscheibe.grey.stw.pengutronix.de with esmtps  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
	(Exim 4.94.2)
	(envelope-from <ukl@pengutronix.de>)
	id 1rSyZR-002HVi-10; Thu, 25 Jan 2024 13:11:01 +0100
...
Subject: [PATCH v5 109/111] pwm: Ensure the memory backing a PWM chip isn't freed while used
Date: Thu, 25 Jan 2024 13:10:11 +0100
Message-ID:  <eba3c87b6b85b385cdc45d1ea5bf9a743d295310.1706182805.git.u.kleine-koenig@pengutronix.de>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=15694; i=u.kleine-koenig@pengutronix.de; h=from:subject:message-id; bh=/Pn3H2sPKWQiH/mueBaf+2K/i8DAREnJPAk0QAkHukE=; b=owEBbQGS/pANAwAKAY+A+1h9Ev5OAcsmYgBlsk+6xTxzsIW3ysHfw6gP6iVih9k597FrrjyZB QsC+VK0xdSJATMEAAEKAB0WIQQ/gaxpOnoeWYmt/tOPgPtYfRL+TgUCZbJPugAKCRCPgPtYfRL+ TvUHB/92U2m/oZZqoPLqoopgTLd1zr+TyxZjZEdZcbwdGB+LdJvHFh5Jvx/8b+oqhWbz7waAOsw jrGPFiTyvoCRyuCbqGQKrOQfDNWuFfjCQnoSeloCARmLV6F/ioA627ES0L5Whv09s+HjGJJdN7T rw7sL0FYgTlMrrn9it/FP7g1MGr1y3+G8RsJvuT5p0jSbg0MOVId84ThB1+kHvr9H2CxeZyNaRf PDFZbe0ckYzS0QT8fNX+S9JY0dK2s/12QZ1d+NA8lPFMaZYHhnzYlh7uwwJ9rCT1LoKerZE4Djx fH6zMWuHSut3/r4VOkvj4khPqcresz37/FMfRoaf3EVyfIgo
...
index e5024dff56b3..a22055b06988 100644
...
+		dev_err(chip->dev.parent, "failed to reapply current setting\n");
 		return;
 	}
...
@@ -459,19 +459,33 @@ static void *pwmchip_priv(struct pwm_chip *chip)
...
@@ -486,23 +500,46 @@ struct pwm_chip *devm_pwmchip_alloc(struct device *parent, unsigned int npwm, si
...
@@ -513,7 +550,7 @@ static bool pwm_ops_check(const struct pwm_chip *chip)
 		return false;
...
+		dev_warn(chip->dev.parent,
 	...
 	return true;
@@ -533,7 +570,7 @@ int __pwmchip_add(struct pwm_chip *chip, struct module *owner)
 {
 	int ret;
...
+	if (!chip || !chip->dev.parent || !chip->ops || !chip->npwm)
 	...
 	/*
@@ -549,25 +586,42 @@ int __pwmchip_add(struct pwm_chip *chip, struct module *owner)
 		return -EINVAL;
...
@@ -589,6 +643,10 @@ void pwmchip_remove(struct pwm_chip *chip)
 	idr_remove(&pwm_chips, chip->id);
...
@@ -622,15 +680,15 @@ static struct device_link *pwm_device_link_add(struct device *dev,
 		 * impact the PM sequence ordering: the PWM supplier may get
 		 * suspended before the consumer.
 		 */
-		dev_warn(pwm->chip->dev,
+		dev_warn(pwm->chip->dev.parent,
...
@@ -645,7 +703,7 @@ static struct pwm_chip *fwnode_to_pwmchip(struct fwnode_handle *fwnode)
 	mutex_lock(&pwm_lock);
 
 	idr_for_each_entry_ul(&pwm_chips, chip, tmp, id)
-		if (chip->dev && device_match_fwnode(chip->dev, fwnode)) {
+		if (chip->dev.parent && device_match_fwnode(chip->dev.parent, fwnode)) {
 			mutex_unlock(&pwm_lock);
 			return chip;
 		}
@@ -973,7 +1031,7 @@ void pwm_put(struct pwm_device *pwm)
...
@@ -1113,8 +1171,8 @@ static int pwm_seq_show(struct seq_file *s, void *v)
...
index 1698609d91c8..5fd518772aa1 100644
...
index d505400f8573..c0f3d1139051 100644
...
@@ -610,17 +611,7 @@ static inline void pwm_remove_table(struct pwm_lookup *table, size_t num)
 }
 #endif
