...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 370147AACCC
	for <lists+linux-pwm@lfdr.de>; Fri, 22 Sep 2023 10:37:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232672AbjIVIhf (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Fri, 22 Sep 2023 04:37:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44004 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232644AbjIVIhe (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Fri, 22 Sep 2023 04:37:34 -0400
Received: from mail.tkos.co.il (guitar.tkos.co.il [84.110.109.230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 26F2383;
        Fri, 22 Sep 2023 01:37:25 -0700 (PDT)
Received: from tarshish (unknown [10.0.8.2])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.tkos.co.il (Postfix) with ESMTPS id BDA834402F4;
        Fri, 22 Sep 2023 11:37:09 +0300 (IDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=tkos.co.il;
        s=default; t=1695371830;
        bh=vIZ0eAo0ZmCv5PzYLGlwppRBM/hXM+Vo9RHfZHfNdRg=;
        h=References:From:To:Cc:Subject:Date:In-reply-to:From;
        b=
References: <17dd231f496d09ed8502bdd505eaa77bb6637e4b.1644226245.git.baruch@tkos.co.il>
 ...
 <87wmwsylup.fsf@tarshish>
 <7b453ce7-7f41-12e7-9c7b-6c7d597037f2@quicinc.com>
...
Date:   Fri, 22 Sep 2023 11:35:33 +0300
In-reply-to: <7b453ce7-7f41-12e7-9c7b-6c7d597037f2@quicinc.com>
Message-ID: <87o7huli2m.fsf@tarshish>
MIME-Version: 1.0
...
> https://lore.kernel.org/linux-arm-msm/8a331c88-c7d4-3a14-0ec3-fd616ea24a9=
9@quicinc.com/
...
>>>>     Use pwm_div division with remainder instead of separate diff calcu=
lation
...
>>>>     Remove x1000 factor in pwm_div calculation, use rate directly, and=
 round
>>>> up
...
>>>>     Integrate enable/disable into config_div_and_duty() to save regist=
er
>>>> read,
...
>>>> +	state->period =3D DIV64_U64_ROUND_UP(effective_div * NSEC_PER_SEC, r=
ate);
>>>> +
