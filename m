Return-Path: <linux-pwm+bounces-494-lists+linux-pwm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pwm@lfdr.de
Delivered-To: lists+linux-pwm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E59F880C30A
	for <lists+linux-pwm@lfdr.de>; Mon, 11 Dec 2023 09:25:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 12B781C20974
	for <lists+linux-pwm@lfdr.de>; Mon, 11 Dec 2023 08:25:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D75E620DE2;
	Mon, 11 Dec 2023 08:25:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=mess.org header.i=@mess.org header.b="ZaCQHWdL";
	dkim=pass (2048-bit key) header.d=mess.org header.i=@mess.org header.b="nlcElCJv"
X-Original-To: linux-pwm@vger.kernel.org
Received: from gofer.mess.org (gofer.mess.org [IPv6:2a02:8011:d000:212::1])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2F637B6;
	Mon, 11 Dec 2023 00:25:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mess.org; s=2020;
	t=1702283124; bh=8QA2D7jqNA9QQov/ttsVMi9mqit0AyVMIzFmfBEtAhU=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
Received: by gofer.mess.org (Postfix, from userid 501)
	id 09205100A05; Mon, 11 Dec 2023 08:25:24 +0000 (GMT)
X-Spam-Level: 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mess.org; s=2020;
...
Subject: [PATCH v7 1/4] pwm: Rename pwm_apply_state() to pwm_apply_might_sleep()
