...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D4DBB75BE7D
	for <lists+linux-pwm@lfdr.de>; Fri, 21 Jul 2023 08:10:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230454AbjGUGJ7 (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Fri, 21 Jul 2023 02:09:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46322 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230290AbjGUGJT (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Fri, 21 Jul 2023 02:09:19 -0400
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 9BCB52D5D;
        Thu, 20 Jul 2023 23:09:03 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="6.01,220,1684767600"; 
   d="scan'208";a="170334014"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie5.idc.renesas.com with ESMTP; 21 Jul 2023 15:09:03 +0900
Received: from localhost.localdomain (unknown [10.226.92.55])
        by relmlir5.idc.renesas.com (Postfix) with ESMTP id C16C140037FE;
        Fri, 21 Jul 2023 15:09:00 +0900 (JST)
...
Subject: [PATCH v15 4/4] pwm: rzg2l-gpt: Add support for gpt linking with poeg
Date:   Fri, 21 Jul 2023 07:08:40 +0100
Message-Id: <20230721060840.8546-5-biju.das.jz@bp.renesas.com>
...
index 38243c1a63ab..3ce03005a5ca 100644
...
@@ -441,6 +454,75 @@ static void rzg2l_gpt_reset_assert_pm_disable(void *data)
...
+
 ...
 {
 	struct rzg2l_gpt_chip *rzg2l_gpt;
@@ -504,6 +586,7 @@ static int rzg2l_gpt_probe(struct platform_device *pdev)
 		}
 	}
