...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 948B8614A22
	for <lists+linux-pwm@lfdr.de>; Tue,  1 Nov 2022 12:58:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230426AbiKAL6Q (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Tue, 1 Nov 2022 07:58:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49188 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230222AbiKAL6K (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Tue, 1 Nov 2022 07:58:10 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9BE9F637B;
        Tue,  1 Nov 2022 04:58:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1667303883; x=1698839883;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=ZF0nEX7vyvkm7l+23o2i4JMrrBmqN1PYXAEUqxDEQYU=;
  b=KQ3Vy4dcLD5IypVy4sZJ19wcULC2YfHY2zm8pLmi8qN4wEL6SvGg1oNE
   /LAvm86kidSOwGjU2btSHofU6ea7TYzQH7PcGpiXGKe+BZc5hGfXI4cse
   D7Es1bi0tmylQK1H0PUh8MersXIysUrbREPiUrDVHjOzmoCa808WroJ+a
   wTIOHuSN5TmUY+vC/gnPTE2++uZfZQd/VXMCSCpubbbsvd8sAKVvO7ow8
   8bnd3td9f+VYYUMMl/SIEh1vJcEYCr8E1su1QtEghFy8MGtg64h2e3hXz
   PE2W+uZqiCZFfGyJregHE66j1IjGJklA8LPK/XHEEY43+c3gJK+8flDvf
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10517"; a="288830907"
X-IronPort-AV: E=Sophos;i="5.95,230,1661842800"; 
   d="scan'208";a="288830907"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Nov 2022 04:58:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10517"; a="739304247"
X-IronPort-AV: E=Sophos;i="5.95,230,1661842800"; 
   d="scan'208";a="739304247"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by fmsmga002.fm.intel.com with ESMTP; 01 Nov 2022 04:57:56 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1opptu-000Db4-1d;
        Tue, 01 Nov 2022 11:57:50 +0000
Date:   Tue, 1 Nov 2022 19:57:11 +0800
...
Subject: Re: [PATCH 2/3] pwm: Add Aspeed ast2600 PWM support
Message-ID: <202211011952.LTIl2uEk-lkp@intel.com>
References: <20221031103809.20225-3-billy_tsai@aspeedtech.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="+fPcVnzbFG6liH4J"
Content-Disposition: inline
In-Reply-To: <20221031103809.20225-3-billy_tsai@aspeedtech.com>
X-Spam-Status: No, score=-3.7 required=5.0 tests=BAYES_00,DKIMWL_WL_HIGH,
        DKIM_SIGNED,DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,RCVD_IN_DNSWL_MED,
        SPF_HELO_PASS,SPF_NONE,UPPERCASE_50_75,URIBL_BLACK autolearn=ham
...
patch link:    https://lore.kernel.org/r/20221031103809.20225-3-billy_tsai%40aspeedtech.com
patch subject: [PATCH 2/3] pwm: Add Aspeed ast2600 PWM support
...
reproduce:
        ...
        # https://github.com/intel-lab-lkp/linux/commit/1e73d9a570e9276911d41cce20e4dcdb0bcdc4d6
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Billy-Tsai/Support-pwm-tach-driver-for-aspeed-ast26xx/20221031-183813
        git checkout 1e73d9a570e9276911d41cce20e4dcdb0bcdc4d6
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross C=1 CF='-fdiagnostic-prefix -D__CHECK_ENDIAN__' O=build_dir ARCH=arm64 SHELL=/bin/bash drivers/perf/ drivers/pwm/

If you fix the issue, kindly add following tag where applicable
| Reported-by: kernel test robot <lkp@intel.com>

sparse warnings: (new ones prefixed by >>)
>> drivers/pwm/pwm-aspeed-ast2600.c:255:52: sparse: sparse: Using plain integer as NULL pointer

vim +255 drivers/pwm/pwm-aspeed-ast2600.c

   231	
   232	static int aspeed_pwm_probe(struct platform_device *pdev)
   233	{
   234		struct device *dev = &pdev->dev;
   235		int ret;
   236		struct aspeed_pwm_data *priv;
   237		struct device_node *np;
   238		struct platform_device *parent_dev;
   239	
   240		priv = devm_kzalloc(dev, sizeof(*priv), GFP_KERNEL);
   241		if (!priv)
   242			return -ENOMEM;
   243	
   244		np = pdev->dev.parent->of_node;
   245		if (!of_device_is_compatible(np, "aspeed,ast2600-pwm-tach"))
   246			return dev_err_probe(dev, -ENODEV,
   247					     "Unsupported pwm device binding\n");
   248	
   249		priv->regmap = syscon_node_to_regmap(np);
   250		if (IS_ERR(priv->regmap))
   251			return dev_err_probe(dev, PTR_ERR(priv->regmap),
   252					     "Couldn't get regmap\n");
   253	
   254		parent_dev = of_find_device_by_node(np);
 > 255		priv->clk = devm_clk_get(&parent_dev->dev, 0);
   256		if (IS_ERR(priv->clk))
   257			return dev_err_probe(dev, PTR_ERR(priv->clk),
   258					     "Couldn't get clock\n");
   259	
   260		priv->reset = devm_reset_control_get_shared(&parent_dev->dev, NULL);
   261		if (IS_ERR(priv->reset))
   262			return dev_err_probe(dev, PTR_ERR(priv->reset),
   263					     "Couldn't get reset control\n");
   264	
   265		ret = clk_prepare_enable(priv->clk);
   266		if (ret)
   267			return dev_err_probe(dev, ret, "Couldn't enable clock\n");
   268	
   269		ret = reset_control_deassert(priv->reset);
   270		if (ret) {
   271			dev_err_probe(dev, ret, "Couldn't deassert reset control\n");
   272			goto err_disable_clk;
   273		}
   274	
   275		priv->chip.dev = dev;
   276		priv->chip.ops = &aspeed_pwm_ops;
   277		priv->chip.npwm = PWM_ASPEED_NR_PWMS;
   278	
   279		ret = pwmchip_add(&priv->chip);
   280		if (ret < 0) {
   281			dev_err_probe(dev, ret, "Failed to add PWM chip\n");
   282			goto err_assert_reset;
   283		}
   284		dev_set_drvdata(dev, priv);
   285		return 0;
   286	err_assert_reset:
   287		reset_control_assert(priv->reset);
   288	err_disable_clk:
