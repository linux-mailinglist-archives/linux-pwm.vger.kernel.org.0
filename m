Return-Path: <linux-pwm+bounces-9740-lists+linux-pwm=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-pwm@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id uCCyNDpRV2q5JAEAu9opvQ
	(envelope-from <linux-pwm+bounces-9740-lists+linux-pwm=lfdr.de@vger.kernel.org>)
	for <lists+linux-pwm@lfdr.de>; Wed, 15 Jul 2026 11:22:02 +0200
X-Original-To: lists+linux-pwm@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id D33AE75C6A8
	for <lists+linux-pwm@lfdr.de>; Wed, 15 Jul 2026 11:22:01 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=jannau.net header.s=fm1 header.b=czMok5ub;
	dkim=pass header.d=messagingengine.com header.s=fm2 header.b="I c36e0G";
	spf=pass (mail.lfdr.de: domain of "linux-pwm+bounces-9740-lists+linux-pwm=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-pwm+bounces-9740-lists+linux-pwm=lfdr.de@vger.kernel.org";
	dmarc=none;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 51CB232208E8
	for <lists+linux-pwm@lfdr.de>; Wed, 15 Jul 2026 09:13:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A31E940D571;
	Wed, 15 Jul 2026 09:12:34 +0000 (UTC)
X-Original-To: linux-pwm@vger.kernel.org
Received: from fout-a8-smtp.messagingengine.com (fout-a8-smtp.messagingengine.com [103.168.172.151])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5AC3B3F788F;
	Wed, 15 Jul 2026 09:12:18 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1784106753; cv=none; b=Yrwu2zY8+mbdSGXOOEtp17zpbgH/0sHFqEJDXENnuxaciFN75BNe+PrKdVWaNNbTW5WuRzx+Dl5f6JZwDlL0CA/E0NknrWQR3afvrEcbXpbDYGWF6OpixUTjvA+pUd/o3ob3koHana51KyH3BLgAgvbX7y8T0LqBQshTuwccQ/s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1784106753; c=relaxed/simple;
	bh=xHEOtEmLAkLickldX4IqOqLLl49AsXotUei6UV5cimI=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=LB433gCfkqXtM1xjdPvCdvFkj4PJO3HJJPCYZqGabuYd+MePOZJuVySLMse+2Ki4o4Txy4D/ar2LpE88UtEhr631d/i+FfAfe0SrUSEK2gEPX6jfdimxX2mJp9GC2wKKVXILCOJ7Hz7A3x3VbArohMznCgsk+9ZmtgnRiq1xusI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=jannau.net; spf=pass smtp.mailfrom=jannau.net; dkim=pass (2048-bit key) header.d=jannau.net header.i=@jannau.net header.b=czMok5ub; dkim=pass (2048-bit key) header.d=messagingengine.com header.i=@messagingengine.com header.b=Ic36e0Gk; arc=none smtp.client-ip=103.168.172.151
Received: from phl-compute-02.internal (phl-compute-02.internal [10.202.2.42])
	by mailfout.phl.internal (Postfix) with ESMTP id C0937EC01E7;
	Wed, 15 Jul 2026 05:12:16 -0400 (EDT)
Received: from phl-frontend-03 ([10.202.2.162])
  by phl-compute-02.internal (MEProxy); Wed, 15 Jul 2026 05:12:16 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=jannau.net; h=cc
	:cc:content-transfer-encoding:content-type:content-type:date
	:date:from:from:in-reply-to:in-reply-to:message-id:mime-version
	:references:reply-to:subject:subject:to:to; s=fm1; t=1784106736;
	 x=1784193136; bh=IvuxmsPqq2Il/IRU3SRJDmQo2aJdssQk6XrfrMOe9AU=; b=
	
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
	messagingengine.com; h=cc:cc:content-transfer-encoding
	:content-type:content-type:date:date:feedback-id:feedback-id
	:from:from:in-reply-to:in-reply-to:message-id:mime-version
	:references:reply-to:subject:subject:to:to:x-me-proxy
	:x-me-sender:x-me-sender:x-sasl-enc; s=fm2; t=1784106736; x=
	1784193136; bh=IvuxmsPqq2Il/IRU3SRJDmQo2aJdssQk6XrfrMOe9AU=; b=I
	
X-ME-Sender: <xms:8E5XasMVI4dqIV-6WtTIeQGOOGylfwEdLn9fx0ictRq5r_CVaQldsw>
    <xme:8E5Xau3ERBXXoi6UgLQukTji_xbRCGuvdQNvuQEtgEsHEoL3uxhDvBWnioFptP-by
    0t79bB6fEqNWlIbS1PoIPBBuPdRpbJyc5BX0D9dMor-psZVXY-iar0>
X-ME-Received: <xmr:8E5XauytxPAxuUZ0lAVOIO1c5Xpcv-7_7Ri_PaBWY03GJ37xXljeR7978bXCNuWOCAUFIbw5l2MxJE8G8txy9jbjVrvuZEOPNNifqQ>
X-ME-Proxy-Cause: dmFkZTFQ30NmwFVOxD18GR49RMUGPlt4wtzp6qHU+/Q42pWknwtU9lmQUE9J/cZRNpkV4h
    ...
    
X-ME-Proxy: <xmx:8E5Xaor_AolbrpEZOjtv7EBnXboCOyazljOccv3kgcAKob8z1JA7mA>
    <xmx:8E5XasWCgMJ6ACLRpd_PgYUMppFLL7Md5dV3F1a15r8PdDWcF4y8TA>
    <xmx:8E5XanpCLGrDqwQt3Eka1lBQjRvOMk4wXn36mmlCGrJG6-liYaLXIQ>
    <xmx:8E5XaoEL1BYZirnuudA4uAyrrR6ZoCG3MbeJE6TAjrZi7E7ng0yKQw>
    <xmx:8E5XakHU9sxXzTEtTfVdklEfXH2j9fctZuSEd4F1NaW7ir5Lh04OLFbt>
Feedback-ID: i47b949f6:Fastmail
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Wed,
 15 Jul 2026 05:12:15 -0400 (EDT)
From: Janne Grunau <j@jannau.net>
Date: Wed, 15 Jul 2026 11:11:56 +0200
Subject: [PATCH v2 09/10] arm64: dts: apple: Initial T603[124] (M3 Max and
 Ultra) device trees
Precedence: bulk
...
Message-Id: <20260715-apple-t603x-initial-devices-v2-9-df65b2485710@jannau.net>
...
X-Mailer: b4 0.15.2
X-Developer-Signature: v=1; a=openpgp-sha256; l=114147; i=j@jannau.net;
 h=from:subject:message-id; bh=xHEOtEmLAkLickldX4IqOqLLl49AsXotUei6UV5cimI=;
 b=
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-9740-lists,linux-pwm=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,vger.kernel.org:from_smtp,messagingengine.com:dkim,jannau.net:from_mime,jannau.net:mid,jannau.net:email,jannau.net:dkim]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: D33AE75C6A8
...
new file mode 100644
index 000000000000..bbf19ecdaaec
--- /dev/null
