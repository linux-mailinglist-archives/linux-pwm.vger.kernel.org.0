...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7F4F5637DEA
	for <lists+linux-pwm@lfdr.de>; Thu, 24 Nov 2022 18:00:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229633AbiKXRAo (ORCPT <rfc822;lists+linux-pwm@lfdr.de>);
        Thu, 24 Nov 2022 12:00:44 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57998 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229612AbiKXRAn (ORCPT
        <rfc822;linux-pwm@vger.kernel.org>); Thu, 24 Nov 2022 12:00:43 -0500
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 8E548B54CF;
        Thu, 24 Nov 2022 09:00:41 -0800 (PST)
X-IronPort-AV: E=Sophos;i="5.96,190,1665414000"; 
   d="scan'208";a="143800400"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 25 Nov 2022 02:00:40 +0900
Received: from localhost.localdomain (unknown [10.226.92.56])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id 794104097826;
        Fri, 25 Nov 2022 02:00:38 +0900 (JST)
...
Subject: [PATCH v7 5/5] pwm: Add Renesas RZ/G2L MTU3a PWM driver
Date:   Thu, 24 Nov 2022 17:00:18 +0000
Message-Id: <20221124170018.3150687-6-biju.das.jz@bp.renesas.com>
...
index 000000000000..6a2b7cb2a5fb
--- /dev/null
...
+
+	if (ch->function != RZ_MTU3_PWM_MODE_1)
+		return -EBUSY;
+
+	ch_index = rz_mtu3_get_hw_channel_index(rz_mtu3_pwm, ch);
+
